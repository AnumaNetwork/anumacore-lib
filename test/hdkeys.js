...
var HDPrivateKey = anumacore.HDPrivateKey;
var HDPublicKey = anumacore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = anumacore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(anumacore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(anumacore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      anumacore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = anumacore.PublicKey.fromPoint;
      anumacore.PublicKey.fromPoint = function() {
        anumacore.PublicKey.fromPoint = unstubbed;

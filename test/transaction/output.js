...
var BufferWriter = anumacore.encoding.BufferWriter;
var BufferReader = anumacore.encoding.BufferReader;
...
describe("Output", function() {
  ...
  it("#toObject roundtrip will handle an invalid (null) script", function() {
    ...
    var br = new anumacore.encoding.BufferReader(invalidOutputScript);

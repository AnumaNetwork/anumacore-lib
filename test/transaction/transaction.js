...
var BN = anumacore.crypto.BN;
var Transaction = anumacore.Transaction;
var Signature = anumacore.Signature;
var Input = anumacore.Transaction.Input;
var Output = anumacore.Transaction.Output;
var PrivateKey = anumacore.PrivateKey;
var Script = anumacore.Script;
var Address = anumacore.Address;
var Networks = anumacore.Networks;
var Opcode = anumacore.Opcode;
var errors = anumacore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(anumacore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(anumacore.Script);

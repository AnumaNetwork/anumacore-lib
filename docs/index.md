...
var imported = anumacore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new anumacore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new anumacore.URI(paymentInfo).toString();
```

...
/*
[
	"anuma:precqv0krj3r6uyyfa36ga7s0u9jct0v4wg8ctsfde2gkrsgwgw8jgxfzfc98",
	"anuma:qqnash4vvcpx3s4qrf47p3rkcd4230sxz7506ejpt4gkpm2fh9xsumafqp07p",
	"anuma:qqwxqxwc0w54vsxlwyzt74enqq4e7d6mjp99l3te48r6ak4auehnqzae9a6uw",
	"anuma:qztdywdh8d9zjztdn8kdvckgch0e8p47gendyzks3lx2n8r70hktujwsy6ums",
	"anuma:qr0we0jumdfr25wpp9her3lk4nere24jmsfvew4z6gfwrj3dhhpny89xs7g6j",
	"anuma:qpdpduavrg6j39e8dn6rsr68yu4p6x6ju695up0p4r4gay0wymm4cged8p758"
].map(addr=>{
 ...
 * and a slightly fancier format recognized by anumacore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a anumacore Address object. The
 * same is true for `script`, which can be a string or a anumacore Script.
 *

 ...
 *
 * @param {string} prefix Network prefix. E.g.: 'anumatest'.
 */
...
const anumaNetworks = ['anuma', 'anumadev', 'anumareg', 'anumatest', 'anumasim'];

anumaNetworks.map((str) => {
  addNetwork({
    name: str,
    prefix: str,
    pubkeyhash: 0x00, // publickey hash prefix
    privatekey: 0x80, // privatekey prefix -- must be 128 or toWIF() result will not match with anuma
    scripthash: 0x05,
